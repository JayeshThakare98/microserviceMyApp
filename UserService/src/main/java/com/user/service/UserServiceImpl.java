...
//        logger.info("{} ", ratingsOfUser);
        ...
        List<Rating> ratingList = ratings.stream().map(rating -> {
            ...
            ResponseEntity<Hotel> forEntity = restTemplate.getForEntity("http://localhost:8082/hotel/hotelbyid/"+rating.getHotelId(), Hotel.class);
            Hotel hotel = forEntity.getBody();//hotelService.getHotel(rating.getHotelId());
